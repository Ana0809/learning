...
public class Test1 {
    private static final List<Integer> x = asList(1, 2, 3, 4, 5,6); // Consecutive hours developer codes
    private static final List<Integer> y = asList(10, 10, 1, 1, 1, 1); // Number of bugs produced
    ...
    public static void main(String[] args) {
        System.out.println(predictForValue(7));
    }
}